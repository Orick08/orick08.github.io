        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-gray-300 leading-relaxed">
              Desarrollador apasionado por crear experiencias web únicas y
              memorables. Me especializo en desarrollo frontend con React y
          ...
          <div className="pt-4 border-t border-[#2a2a2a]">
            ...
            <div className="grid grid-cols-2 gap-3">
              {["React", "TypeScript", "Tailwind CSS", "UI/UX Design"].map(
                (skill) => (
                  <div
                    key={skill}
